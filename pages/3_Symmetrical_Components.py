...
st.markdown("👇 **Change the length of the power line to control the place of the fault and watch how the fault current changes!**  \n"   "💭 What influence has the length of the power line on the fault current?")      
c2= st.radio(
    "lenght",
    ('The increase of the length has no influence on the fault current','The increase of the length leads to a higher fault current', 'The increase of the length leads to a lower fault current'),key='ch2' ,horizontal=False, label_visibility="hidden")    


if c2=='The increase of the length leads to a lower fault current':
    st.markdown(r'''
                ** :green[Thats correct!]**\
                ...
                With a lower length of the power line, the impedance gets smaller and the fault current increases.
                ''') 
...
if c2=='The increase of the length leads to a higher fault current' or c2=='The increase of the length has no influence on the fault current':
    st.markdown(r'''
...
st.markdown("As you have seen so far the height of the fault current is depending on the type of fault and on the place of the fault.  \n"   "Use the full simulation model on the next page to test different faults and to find the worst case scenario for the power line!  \n"
"💡 You can use sidebar on the left side to select *Symmetrical Components Simulation Model* page.\n"
           )
